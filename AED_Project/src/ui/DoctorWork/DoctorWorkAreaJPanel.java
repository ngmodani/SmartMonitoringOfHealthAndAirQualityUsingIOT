...
public class DoctorWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public DoctorWorkAreaJPanel(JPanel userProcessContainer, Enterprise e, UserAccount account) {
        initComponents();

        this.userProcessContainer = userProcessContainer;
        this.userAccount = account;
        this.e = e;
        this.docOrganization = (DoctorOrganization) e.getOrganizationDirectory().getOrganizationList().get(0);
        lblDay.setText("Welcome " + account.getPerson().getName());
        populateTable();
    }
    ...
    public void populateTable() {
        ...
        for (WorkRequest request : docOrganization.getWorkQueue().getWorkRequestList()) {
            ...
            row[0] = request;
            row[1] = request.getSender().getResident().getName();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(23, 58, 650, 96));
        ...
        add(assignJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 220, -1, -1));
        ...
        add(processJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 220, -1, -1));
        ...
        lblDay.setText("Welcome");
        add(lblDay, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, 210, -1));
    ...
    private void assignJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_assignJButtonActionPerformed
        ...
        if (request.getReceiver() != null) {
            JOptionPane.showMessageDialog(this, "Request already with another Doctor!", "Error", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        ViewPatientDetailsJPanel vpdjp = new ViewPatientDetailsJPanel(userProcessContainer, request);
