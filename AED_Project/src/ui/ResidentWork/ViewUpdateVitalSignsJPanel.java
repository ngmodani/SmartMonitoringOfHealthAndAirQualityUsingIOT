...
public class ViewUpdateVitalSignsJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        editVitalSignJButton.setBackground(new java.awt.Color(153, 153, 153));
        editVitalSignJButton.setFont(new java.awt.Font("Chalkduster", 1, 14)); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(dateJTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void saveJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveJButtonActionPerformed
        ...
        try {
            int rr = Integer.parseInt(respiratoryRateJTextField.getText());
            int hr = Integer.parseInt(heartRateJTextField.getText());
            int bp = Integer.parseInt(bloodPressureJTextField.getText());
            int w = Integer.parseInt(weightJTextField.getText());
            if (rr < 300 && hr < 200 && bp < 300 && w < 500) {
                vitalSign.setRespiratoryRate(rr);
                vitalSign.setHeartRate(hr);
                vitalSign.setBloodPressure(bp);
                vitalSign.setWeight(w);

                JOptionPane.showMessageDialog(this, "Vital Sign updated!", "Update", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "Values out of range!", "ERROR", JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (Exception ex) {
    ...
    private void populateVitalSignDetails() {
        ...
        dateJTextField.setText(String.valueOf(vitalSign));
    }
